...
public class UserOfSelfAdminScene extends BaseTests {
    ...
    public void test() throws Exception {
        AccountManager accountManager =
                AccountManager.load(
                        accountManagerU.getContractAddress(), web3j, p1, contractGasProvider);
        WEGovernance governance =
                WEGovernance.load(governanceU.getContractAddress(), web3j, p1, contractGasProvider);
        ...
        String p1AccountAddress = accountManager.getUserAccount(p1.getAddress()).send();
        ...
        Assertions.assertEquals("0x0", tr.getStatus());
        Assertions.assertEquals(2, baseAccountService.getStatus(p2, p1AccountAddress));
        Assertions.assertTrue(!accountManager.hasAccount(p1.getAddress()).send());
        ...
        System.out.println("p1: " + p1.getAddress());
        Assertions.assertTrue(accountManager.hasAccount(p1.getAddress()).send());
        p1AccountAddress = accountManager.getUserAccount(p1.getAddress()).send();

        // cancel account
        tr = endUserAdminManager.cancelAccount();
        Assertions.assertEquals("0x0", tr.getStatus());
        Assertions.assertEquals(2, baseAccountService.getStatus(p1, p1AccountAddress));
        Assertions.assertTrue(!accountManager.hasAccount(p1.getAddress()).send());
