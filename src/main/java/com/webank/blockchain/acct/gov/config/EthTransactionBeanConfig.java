...
/**
 * EthTransactionBeanConfig @Description: EthTransactionBeanConfig
 *
 * @author maojiayu
...
public class EthTransactionBeanConfig {
    ...
    public ExtendedRawTransactionManager get() {
        ExtendedRawTransactionManager manager =
                new ExtendedRawTransactionManager(
                        web3j,
                        credentials,
                        BigInteger.valueOf(systemEnvironmentConfig.getGroupId()),
                        BigInteger.ONE);
        return manager;
    }
}
