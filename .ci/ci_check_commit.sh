...
ignore_files=(sh crt key json toml md bin abi txt AccountManager.java BaseAccount.java UserAccount.java WEBasicAuth.java WEGovernance.java AdminGovernBuilder.java BaseAccountInterface.java VoteGovernBuilder.java WEBoardVoteGuard.java WeightVoteGovernBuilder.java)
commit_limit=6
